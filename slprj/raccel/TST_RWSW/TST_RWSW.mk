...
MODEL                = TST_RWSW
MODULES              = rt_logging.c TST_RWSW.c TST_RWSW_capi.c TST_RWSW_data.c TST_RWSW_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = TST_RWSW.exe
MAKEFILE             = TST_RWSW.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/m_mam/DOCUME~1/AEROSP~1/MENGPR~1/ADCS
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = TST_RWSW_ref.rsp
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/TST_RWSW \
